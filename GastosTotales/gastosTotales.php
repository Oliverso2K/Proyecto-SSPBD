...
<head>
    ...
    <title>Gastos Individuales Totales</title>
</head>
...
<body>
    ...
    <div class="titulo-ventana">
        <h5> Consulta Individual > Gastos individuales totales </h5>
            <h2> GASTOS INDIVIDUALES TOTALES </h2>
    </div>
                ...
                <table>
                    ...
                    <?php
                        while ($fila = pg_fetch_array($consultaPersonas)){
                            ...
                            $sql = "SELECT cantidad FROM gastos WHERE id_persona='$id_persona'";
